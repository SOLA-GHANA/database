...
shp2pgsql -a -s $srid -g geom $dest_dir/$sectionnr/shape_block/PAL staging_area.shape_block > $dest_dir/shptmp.sql

#less $dest_dir/shptmp.sql
...
shp2pgsql -a -s   $srid  -g geom $dest_dir/$sectionnr/shape_lot/PAL staging_area.shape_lot > $dest_dir/tmp.sql 
